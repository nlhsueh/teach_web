...
打開瀏覽器，進入[逢甲資工系](https://www.csie.fcu.edu.tw/)首頁，按下 F12, 或是直接在頁面按滑鼠右鍵，選擇「檢查」，觀察 [逢甲資工系](https://www.csie.fcu.edu.tw/) 的請求 Headers。
...
link: <https://www.fcu.edu.tw/wp-json/wp/v2/pages/2>; rel="alternate"; type="application/json"
...
- **x-cache: Miss from cloudfront** & **via**：這表示網站使用了 **CDN (CloudFront)** 加速技術。`Miss` 代表這是直接從原始伺服器抓取的，而非緩衝區。
